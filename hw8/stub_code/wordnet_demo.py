...
def load_wordnet_ids(filename):
    ...
    for line in csvreader:
        word_ids[line['synset_id']] = {'synset_offset': line[
            'synset_offset'], 'story_' + type: line['story_' + type], 'stories': line['stories']}
    return word_ids
...
if __name__ == "__main__":
    ...
    for rodent_synset in rodent_synsets:
        ...
        # EACH SYNONYM'S HYPONYMS (MORE SPECIFIC)
    ...
    # Answer: the lion
    # Sch: The lion laughed aloud because he thought that the mouse is
    # extremely not able to help him.
    ...
    for mirth_synset in mirth_synsets:
        ...
        print("\n'%s' is in our dictionary: %s" %
              (mirth_synset.name(), (mirth_synset.name() in verb_ids)))
